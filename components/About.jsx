    ...
    >
      ...
      <div className="bg-black-700 text-white font-poppins  justify-center md:grid place-items-center col-span-2">
        ...
        <p className="py-5 sm:text-2xl text-xl ">
          I am a researcher, currently working on AI/ML bias. My goal is to
          develop tools to detect and mitigate bias in real-world applications.
          From my standpoint, technology should be equitable and inclusive. I am
          enthusiastic about contributing in this area to make it a reality.
          Moreover I am a passionate front-end engineer who is constantly
          looking for opportunities to apply my expertise in web development to
          produce visually appealing and user-friendly applications and
          websites. In my free time, I like to play Genshin Impact, watch
          movies, and doodle.
        </p>
        <a
          href=""
      ...
      <div className=" grid place-items-center md:grid place-items-left ">
        <div className="bg-transparent">
          <iframe
            src="https://drive.google.com/file/d/1xTxEwdaWWwrCWbgh3imWOnCQWaH-g0ke/preview"
            width="300"
            height="325"
